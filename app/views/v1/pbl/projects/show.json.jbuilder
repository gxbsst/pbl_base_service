...
json.techniques @project.techniques.try(:map, &:technique_id) if @include_techniques
json.standard_items @project.standard_items.try(:map, &:standard_item_id) if @include_standard_items
json.rules @project.rules.try(:map, &:gauge_id) if @include_rules
