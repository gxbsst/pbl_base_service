...
describe V1::Pbl::StandardItemsController do
 let(:project) { create :pbl_project }

 describe 'GET #index' do
  let!(:clazz_instance_1)  { create :pbl_standard_item,  project_id: project.id }
  let!(:clazz_instance_2)  { create :pbl_standard_item,  project_id: project.id }

  before(:each) do
   get '/pbl/standard_items', {project_id: project.id}, accept
